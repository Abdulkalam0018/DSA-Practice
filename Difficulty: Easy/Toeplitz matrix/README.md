<h2><a href="https://www.geeksforgeeks.org/problems/toeplitz-matrix/1?_gl=1*ae4srx*_up*MQ..&gclid=Cj0KCQjw7cLOBhDmARIsAGsuA0kVqsVUZ_NqqB3O5AU6BDjsMMX6Bu0EjW0r8-e_UeQETGVNdmSOdqgaAi16EALw_wcB&gbraid=0AAAAAC9yBkAqiacBIztpHLlCjNmx34Htq">Toeplitz matrix</a></h2><h3>Difficulty Level : Difficulty: Easy</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">A <strong>Toeplitz matrix</strong> (also known as a diagonal-constant matrix) is a matrix in which every descending diagonal from left to right contains the same element.</span></p>
